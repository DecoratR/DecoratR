...
internal static class DecoratorRegistryEmitter
{
    ...
    private static void EmitApplyMethod(StringBuilder sb, DecoratorMetadata decorator)
    {
        ...
        sb.Append("    /// Applies <c>").Append(StripGlobalPrefix(decorator.DecoratorFullyQualifiedName))
            .AppendLine("</c> as a decorator.");
        sb.AppendIndentedLine(1, "/// </summary>");
    ...
    private static void EmitDecorateServiceCore(StringBuilder sb)
    {
